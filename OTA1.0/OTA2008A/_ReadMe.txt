OpenTravel 2008A Publication Release Notes


==========================
2008A Publication Contents
==========================
- The following documents are included with 2008A Publication:
...
- XML Instance files- Example XML instance documents in individual files that are taken directly from the OTA_MessageUsersGuide2008AV1.0.pdf.

----------- OTA2008A_XMLFlattenedSchema (folder) -----------  
...
----------- OTA_MessageUsersGuide2008AV1.0.pdf ----------- 
...
----------- OTA2008AReleaseNotes.pdf ----------- 
- The release notes detail the latest information and changes for any given release. This file contains detailed documentation on changes made between the 2007A release and the 2008A release. 
...
========================
OTA_TourProductDescriptionNotifRQ.xsd and OTA_TourProductDescriptionNotifRS.xsd
OTA_TourSearchRQ.xsd and OTA_TourSearchRS.xsd
OTA_TourAvailRQ.xsd and OTA_TourAvailRS.xsd

- It is important to note that numerous other changes have been made in the 2008A publication based on comments received. These changes are documented in the 'OTA2008AReleaseNotes.pdf' document cited above.
