...
=============================================
OPENTRAVEL 2016A README
=============================================

=============================
2016A Publication Contents
=============================

- The following documents are included with the OpenTravel 2016A Publication:

----------- OpenTravel_CodeTable (folder) -----------  
- OpenTravel_CodeLists_2016_05_20.zip - A folder containing the OpenTravel Code Table zip file in Microsoft Excel format. The OpenTravel Code List and the OpenTravel Optimized Code List (Phase I) spreadsheets, included with the specification download, includes an alphabetized, point and click list of all OpenTravel Code List names (with 3 character abbreviations) and errors and warnings to help implementers quickly find code list values.

----------- OpenTravel_2016A_XML (folder) -----------
- XML Schema files- OpenTravel XML Schema messages. 

----------- OpenTravel_2016A_Schema_Versioning.pdf ----------- 
- OpenTravel began tracking versions in the 2003B release cycle. Prior to the 2008A release, the version table contained 2001 and 2002 data for newly created messages. This document contains a table with each OpenTravel message version from 2006A through 2016A.

----------- OpenTravel_2016A_Comments_Report.pdf ----------- 
- This document contains comments that were entered against the OpenTravel 2015B specification and resulted in changes to the 2016A specification.
...
----------- OpenTravel_2016A_XMLMessageSuite_ReleaseNotes.pdf ----------- 
- The release notes detail the latest information and changes for any given release. This file contains detailed documentation on changes made between the 2015B release and the 2016A release. 

----------- OpenTravel_2016A_Message_Users_Guide.pdf ----------- 
...
=================================================
2016A Significant Schema Updates
=================================================

----Modified Schema----

Common
-- Added two enumerations: DinersClub and JapanCreditBureau to OTA_Lists/List_PaymentCardIssuer_Base to specify Diners Club and Japan Credit Bureau as card types.   

Hotel
-- A required attribute @HotelContentInd of type xs:boolean was added to OTA_HotelCacheChangeRQ/CacheSearchCriteria to indicate if changes occurred in hotel content data for the designated cache search criteria.
-- A required attribute @AvailabilityInd of type xs:boolean was added to OTA_HotelCacheChangeRS/CacheChangeInfo to indicate if changes occurred in Availability data for the designated cache search criteria.
-- A required attribute @RatesInd of type xs:Boolean was added to OTA_HotelCacheChangeRS/CacheChangeInfo to indicate if changes occurred in Rates data for the designated cache search criteria.
-- A required attribute @HotelContentInd of type xs:Boolean was added to OTA_HotelCacheChangeRS/CacheChangeInfo to indicate if changes occurred in Hotel Content data for the designated cache search criteria.
-- Typed attribute @CacheEndDateTime of type xs:dateTime in to OTA_HotelCacheChangeRQ/CacheSearchCriteria/CacheSearchCriterion/CacheEndDateTime as the type was missing from this attribute so the type was defaulting to a string.

Vehicle
--Added optional attribute @status of type InventoryStatusType to OTA_VehicleCommonTypes/VehicleEquipmentType to specify the availability of the equipment.
